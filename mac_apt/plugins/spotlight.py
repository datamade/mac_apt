...
import logging
import struct
from mac_apt.plugins.helpers import spotlight_parser as spotlight_parser
from mac_apt.plugins.helpers.spotlight_filter import create_views_for_ios_db
...
def Plugin_Start_Standalone(input_files_list, output_params):
    ...
    for input_path in input_files_list:
        ...
        if os.path.basename(input_path).lower().endswith('.db'):
            try:
